  ...
  <div class="player" v-show="playList.length > 0">
      ...
      <div class="normalPlayer" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="disableState">
              <i  @click="prev" class="icon-prev"></i>
            </div>
            <div class="icon i-center" :class="disableState">
              <i @click="togglePlaying" :class="playIcon"></i>
            </div>
            <div class="icon i-right" :class="disableState">
    ...
    <transition name="mini">
      <div class="miniPlayer" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img width="40" height="40" :src="currentSong.image" :class="cdState">
        </div>
        <div class="text">
